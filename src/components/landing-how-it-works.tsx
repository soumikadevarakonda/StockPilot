...
const steps = [
  {
    ...
    description: "Sign up in seconds and start your trading journey with a virtual portfolio.",
  },
  {
    icon: <IndianRupee className="h-8 w-8" />,
    title: "Get Virtual Cash",
    description: "We'll fund your account with virtual money so you can start trading immediately.",
  },
  {
    icon: <AreaChart className="h-8 w-8" />,
    title: "Start Trading",
    description: "Buy and sell stocks with real-time data and see how your strategies perform.",
  },
]
